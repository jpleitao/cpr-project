...
In the next section, Table \ref{experiments_summary_table} presents the different combinations of clustering algorithms and parameters ranges used. Subsequent sections provide a more detailed overview of the different steps followed in this work.

\section{Summary of the Experiments}
\label{experiments_summary}

Colocar a tabela com label "experiments\_summary\_table"
