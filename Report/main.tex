...
\begin{abstract}
	...
	In the conducted analysis the number of clusters that best fits the data appears to be $4$, covering about three distinct periods of time during the year: The early Summer (June and July), the main Summer months and beginning of Autmn (July, August and September), and the remaining of the year (also with a brief incidence during the mentioned months).
	
	Following the adopted and discussed methodology an automatic categorisation of water consumptions is possible without resorting to any source other than the consumptions dataset. As such, this approach can certainly improve the management of existing water infrstructures, as well as reduce excess water stored in supply storage tanks.	
\end{abstract}
